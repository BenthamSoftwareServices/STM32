...
#define LED_Green  GPIO_PIN_3 //pin for on-board green LED, PB3 on CubeMX pinout view and D13 on the module PCB
...
void Task01_init(void *argument)
{
  /* USER CODE BEGIN Task01_init */
	...
	for (;;) {
		...
		//osDelay(1); //better than HAL_Delay(500)when using RTOS
